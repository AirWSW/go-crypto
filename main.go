...
func main() {
	fmt.Printf(" DES CTR %x\n", desCTR(
		[]byte{0x6e, 0x5e, 0xe2, 0x47, 0xc4, 0xbf, 0xf6, 0x51},
		[]byte{0xa3, 0xc2, 0x60, 0xb1, 0x0b, 0xb7, 0x28, 0x6e},
		[]byte{
...
func desCTR(key, iv, in []byte) []byte {
...
func tripleDESCTR(key, iv, in []byte) []byte {
